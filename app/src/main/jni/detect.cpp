...
Java_com_example_leek_camera_1inference_DetectManager_detect(JNIEnv *env, jclass type, jbyteArray nv21Yuv_,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_leek_camera_1inference_DetectManager_delete_1graph_1space(JNIEnv *env, jclass type) {
...
Java_com_example_leek_camera_1inference_DetectManager_delete_1out_1data(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_leek_camera_1inference_DetectManager_get_1graph_1space(JNIEnv *env, jclass type,
                                                              jstring model_name_,
                                                              jstring model_path_,
                                                              jstring proto_path_,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_leek_camera_1inference_DetectManager_get_1out_1data(JNIEnv *env, jclass type,
